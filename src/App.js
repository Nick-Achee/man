...
function Shoe(props) {
  ...
  useFrame((state) => {
    ...
    ref.current.rotation.y = Math.cos(t / -100) / .003
...
export default function App() {
  return (
    ...
    <Button href="https://nickachee.xyz">Digital Strategy</Button></Grid></Grid>
      ...
      <Canvas concurrent pixelRatio={[1, 1.5]}  camera={{ fov: 60, position: [1 , 0, -9] }}>
        ...
        <Suspense fallback={<Loader />}>
          ...
          <ContactShadows rotation-x={Math.PI / 2} position={[0, -0.9, 0]} opacity={0.55} width={4} height={20} blur={2} far={1} />
        </Suspense>
